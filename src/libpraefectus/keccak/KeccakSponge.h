...
/* 2014-07-03, Jason Lingle
 * Replace ALIGN with KECCAK_ALIGN. Undefining a system-provided symbol is
 * Wrong, and there's no reason to need "ALIGN" specifically.
 */
...
/**
  ...
  */
KECCAK_ALIGN typedef struct Keccak_SpongeInstanceStruct {
    /** The state processed by the permutation. */
    KECCAK_ALIGN unsigned char state[KeccakF_width/8];
